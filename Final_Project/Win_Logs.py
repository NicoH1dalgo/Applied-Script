    ...
    if menu_option  == "1":
        try: 
            ...
            try:
                ...
                print(f"\n[{today_date}] Error 666: Operative system is {sys.platform}")
                with open("Logs.txt","a") as file:
                    file.write(f"\n[{today_date}] Error 999: Script was run without Admin priviledges")
        ...
        print("=" * 25 + "You must choose one of the optiones 1, 2 or 3 !" + 25 * "=")
        with open("Logs.txt","a") as file:
